  ...
  return (
    <>
      ...
      <ul className={`menu-nav ${layoutProps.ulClasses}`}>
        ...
        {/* begin::section */}
        <li className="menu-section ">
          <h4 className="menu-text">Sistem</h4>
          <i className="menu-icon flaticon-more-v2"></i>
        </li>
        {/* end:: section */}
        ...
        <li className="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
          <a href="#" className="menu-link menu-toggle">
            ...
            <span className="menu-text">Kullanıcı Yönetimi</span>
            <i className="menu-arrow"></i>
          </a>
          <div className="menu-submenu">
            <i className="menu-arrow"></i>
            <ul className="menu-subnav">
              <li
                className={`menu-item ${getMenuItemActive("/system/professions")}`}
                aria-haspopup="true"  >
                <NavLink className="menu-link" to="/system/professions">
                  <i className="menu-bullet menu-bullet-line">
                    <span></span>
                  </i>
                  <span className="menu-text">Meslekler</span>
                </NavLink>
              </li>
              <li
                className={`menu-item ${getMenuItemActive("/system/users")}`}
                aria-haspopup="true"  >
              ...
              <li className="menu-item" aria-haspopup="true">
                <a href="custom/apps/inbox.html" className="menu-link">
                  ...
                  <span className="menu-text">Kullanı Talep</span>
                </a>
              </li>
            </ul>
          </div>
